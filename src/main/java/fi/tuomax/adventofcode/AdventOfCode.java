...
import fi.tuomax.adventofcode.year2017.day06.MemoryReallocation_Part1;
import fi.tuomax.adventofcode.year2017.day06.MemoryReallocation_Part2;
import fi.tuomax.adventofcode.year2017.day07.RecursiveCircus_Part1;
...
import fi.tuomax.adventofcode.year2017.day10.KnotHash_Part1;
...
import fi.tuomax.adventofcode.year2017.day13.PacketScanners_Part1;
import fi.tuomax.adventofcode.year2017.day13.PacketScanners_Part2;
import fi.tuomax.adventofcode.year2017.day14.DiskDefragmentation_Part1;
import fi.tuomax.adventofcode.year2017.day14.DiskDefragmentation_Part2;
import fi.tuomax.adventofcode.year2017.day15.DuelingGenerators_Part1;
import fi.tuomax.adventofcode.year2017.day15.DuelingGenerators_Part2;
import fi.tuomax.adventofcode.year2017.day16.PermutationPromenade_Part1;
import fi.tuomax.adventofcode.year2017.day16.PermutationPromenade_Part2;
import fi.tuomax.adventofcode.year2017.day17.Spinlock_Part1;
...
import fi.tuomax.adventofcode.year2017.day19.ASeriesOfTubes_Part2;
import fi.tuomax.adventofcode.year2017.day20.ParticleSwarm_Part1;
...
import fi.tuomax.adventofcode.year2017.day22.SporificaVirus_Part2;
import fi.tuomax.adventofcode.year2017.day23.CoprocessorConflagration_Part1;
...
public class AdventOfCode 
{
    ...
    private void addSolvers2017() {
        ...
        solvers.addSolver(new SpiralMemory_Part2());
        /* day 4 */
        ...
        /* day 6 */
        solvers.addSolver(new MemoryReallocation_Part1());
        solvers.addSolver(new MemoryReallocation_Part2());
        /* day 7 */
        solvers.addSolver(new RecursiveCircus_Part1());
        solvers.addSolver(new RecursiveCircus_Part2());
        /* day 8 */
        ...
        /* day 10 */
        solvers.addSolver(new KnotHash_Part1());
        solvers.addSolver(new KnotHash_Part2());
        /* day 11 */
        ...
        /* day 13 */
        solvers.addSolver(new PacketScanners_Part1());
        solvers.addSolver(new PacketScanners_Part2());
        /* day 14 */
        solvers.addSolver(new DiskDefragmentation_Part1());
        solvers.addSolver(new DiskDefragmentation_Part2());
        /* day 15 */
        solvers.addSolver(new DuelingGenerators_Part1());
        solvers.addSolver(new DuelingGenerators_Part2());
        /* day 16 */
        solvers.addSolver(new PermutationPromenade_Part1());
        solvers.addSolver(new PermutationPromenade_Part2());
        /* day 17 */
        solvers.addSolver(new Spinlock_Part1());
        solvers.addSolver(new Spinlock_Part2());
        /* day 18 */
        solvers.addSolver(new Duet_Part1());
        solvers.addSolver(new Duet_Part2());
        /* day 19 */
        solvers.addSolver(new ASeriesOfTubes_Part1());
        solvers.addSolver(new ASeriesOfTubes_Part2());
        /* day 20 */
        solvers.addSolver(new ParticleSwarm_Part1());
        solvers.addSolver(new ParticleSwarm_Part2());
        /* day 21 */
        solvers.addSolver(new FractalArt_Part1());
        solvers.addSolver(new FractalArt_Part2());
        /* day 22 */
        solvers.addSolver(new SporificaVirus_Part1());
        solvers.addSolver(new SporificaVirus_Part2());
        /* day 23 */
        solvers.addSolver(new CoprocessorConflagration_Part1());
        solvers.addSolver(new CoprocessorConflagration_Part2());
        /* day 24 */
